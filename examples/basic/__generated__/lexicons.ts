...
export const schemaDict = {
  ...
  DevFlyBffbasicProfile: {
    lexicon: 1,
    id: 'dev.fly.bffbasic.profile',
    defs: {
      main: {
        type: 'record',
...
export const ids = {
  ...
  DevFlyBffbasicDefs: 'dev.fly.bffbasic.defs',
  DevFlyBffbasicProfile: 'dev.fly.bffbasic.profile',
} as const
