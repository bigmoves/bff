...
import type * as AppBskyActorDefs from '../bsky/actor/defs.ts'

const is$typed = _is$typed,
  validate = _validate
const id = 'app.bigmoves.defs'

/** width:height represents an aspect ratio. It may be approximate, and may not correspond to absolute dimensions in any given unit. */
export interface AspectRatio {
  $type?: 'app.bigmoves.defs#aspectRatio'
  width: number
  height: number
}
...
export interface GalleryView {
  $type?: 'app.bigmoves.defs#galleryView'
  uri: string
  cid: string
...
export interface ViewImage {
  $type?: 'app.bigmoves.defs#viewImage'
  cid: string
